...
const handleSubmit = async(e)=>{
    ...
    if (!demandData.customerId || !demandData.crop || !demandData.quantity || !demandData.date) {
        alert("Please fill in all the required fields");
        return;
    }

    if (isNaN(demandData.quantity) || demandData.quantity <= 0) {
        alert("Please enter a valid quantity");
        return;
    }

    if (isNaN(new Date(demandData.date).getTime())) {
...
return (
    ...
    <div className=" container mx-w-sm p-4 bg-white rounded shadow-md">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col space-y-4">
            <div>
                ...
                <input
                    ...
                    className="border p-2 w-full rounded shadow-md"
                    required
                />
            </div>
            <div>
